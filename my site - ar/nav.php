    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto" style="">
            <li class="nav-item active">
                <a class="nav-link" href="index.php" style="color: #9837b1;font-size: 20px; font-family: none; font-weight: bold;"><i class="fa fa-fw fa-home"></i>الرئيسية <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="product.php" style="color: #9837b1;font-size: 20px; font-family: none; font-weight: bold;">المنتجات</a>
            </li>
			 <li class="nav-item">
                <a class="nav-link" href="contact.php" tabindex="-1" style="color: #9837b1;font-size: 20px; font-family: none; font-weight: bold;"><i class="fa fa-fw fa-envelope"></i>الاتصال</a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"style="color: #9837b1;font-size: 20px; font-family: none; font-weight: bold;">
                    قائمة
                </a>
			...
			<li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: #9837b1;font-size: 20px; font-family: none; font-weight: bold;">
                   <i class="fa fa-fw fa-user"></i> الحساب
                </a>
			...
			<li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: #9837b1;font-size: 20px; font-family: none; font-weight: bold;padding-right: 30px;">
                   <i class="fa fa-fw fa-language"></i> اللغة
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="#">العربية</a>
					<div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="../product.php">الانجليزية</a>
